    ...
    <div>
      <div>
        <div>
            ...
            <CardBody>
              ...
              {/* <Grid container spacing={3}>
                <Grid item xs={12} sm={6} md={3}>
                  <Grid >
                  <p>PO Status</p> - <b>{poraised}</b>
                  </Grid>
                </Grid>

                <Grid item xs={12} sm={6} md={3}>
                  <p>Pending-</p> <b>{popending}</b>
                </Grid>

                <Grid item xs={12} sm={6} md={3}>
                  <p>Approved</p> - <b>{poapproved}</b>
                </Grid>
              </Grid> */}

              <div className="threecard" id="threecard">
                {/* {localStorage.getItem('Approval2') === 'N' && localStorage.getItem('Approval3') ==='N' && localStorage.getItem('AdminUser') === 'N'? ( */}
                <Row>
                  {card3 ? (
                    <Col lg={23} md={26} sm={26} xs={12}>
                      <Card style={{border:"none"}} className="card1" onClick={GetnoadminData2}>
                        <CardBody className="card133bd" id="card211" style={{borderRadius:"20px"}}>
                          <EmojiObjectsIcon size="large" />
                          {/* <p>PO Status</p>  - <b>{completecouts}</b> */}
                          <p>PO Status</p> - <b>{poraised}</b>
                        </CardBody>
                      </Card>
                    </Col>
                    ...
                    <Col lg={23} md={26} sm={26} xs={12}>
                      ...
                      >
                        <CardBody className="card12bd" style={{borderRadius:"20px"}}>
                          <EmojiObjectsIcon size="large" />
                          <p>PO Status</p> - <b>{poraised}</b>
                        </CardBody>
                      </Card>
          ...
          <Card className="card1" id="card211" onClick={getdsh1}>
                ...
                <Row>
                  {card1 ? (
                    <Col lg={4} md={6} sm={6} xs={12} className="mb-3">
                      <Card style={{border:"none",backgroundColor:"white"}} className="card1" onClick={GetnoadminData}>
                        <CardBody style={{borderRadius:"20px"}} className="card133bd" id="card213">
                          <EmojiObjectsIcon size="large" />
                    ...
                    <Col lg={4} md={6} sm={6} xs={12} className="mb-3">
                      ...
                      >
                        <CardBody className="card1bd" style={{borderRadius:"20px"}}>
                          <EmojiObjectsIcon size="large" />
                          <p>Pending </p> - <b>{popending}</b>
                        </CardBody>
                      </Card>
...
<p>Pending </p>  - <b>{pendingcount}</b>
                ...
                <Row>
                  {card2 ? (
                    <Col lg={23} md={26} sm={26} xs={12}>
                      <Card style={{border:"none",backgroundColor:"white"}} className="card1" onClick={GetnoadminData1}>
                        <CardBody className="card133bd"  style={{borderRadius:"20px"}} id="card212">
                          <EmojiObjectsIcon size="large" />
                          {/* <p>Approved</p>  - <b>{statuscounsts}</b> */}
                          <p>Approved</p> - <b>{poapproved}</b>
                        </CardBody>
                      </Card>
                    </Col>
                    ...
                    <Col lg={23} md={26} sm={26} xs={12}>
                      <Card style={{border:"none",backgroundColor:"white"}} className="card1" onClick={GetnoadminData1}>
                        <CardBody className="card13bd" style={{borderRadius:"20px"}} id="card212">
                          <EmojiObjectsIcon size="large" />
                          <p>Approved</p> - <b>{poapproved}</b>
                        </CardBody>
                      </Card>
...
<Row>
          ...
          {card2 ? (
           ...
           <Col lg={23} md={26} sm={26} xs={12}>
             <Card className="card1"  onClick={Getdatafordashboard3}>
 ...
 <Col lg={23} md={26} sm={26} xs={12}>
             <Card className="card1"  onClick={Getdatafordashboard3}>
              ...
              <div className="Tabelinspections">
                <TableContainer>
                  <Table className="InspectionTbls1" style={{borderRadius:'20px'}}>
                    <TableHead>
                      <TableRow>
