...
const misreport1 = () => {
  ...
  const Getallproductsmaterialise = async () => {
    const get = await axios.instance
      .get('/Getallmaterialrecepitproduct', {
        headers: { Authorization: tokent, 'Content-Type': 'application/json' },
      })
      .then(res => {
        // setallsuppliers(res.data)
  ...
  const ExportToexcel1 = () => {
    ...
    ws.cell(1, 1, 1, 15, true)
      .string('Material Receipt Report')
      .style(headings);
  ...
  return (
    <React.Fragment>
      <div>
        ...
        <h6 className="titlemrr">Material Receipt Report</h6>
          <Card >
            {/* <CardTitle
              tag="h6"              
              className="titlemrr"
              ...
              <Row>
                ...
                {productid != '0' ? (
                  <Col sm={12} lg={3} md={6} style={{ marginTop: '33px' }}>
                    <div>
                      <p>
                        <span className="text-primary">Total Qty :</span>
                    ...
                    {materialissueentrycollection.length != 0 ? (
                      changepage().map(data => (
                        <TableRow>
                          ...
                          <TableCell>{data.Delivery_Chellan_No}</TableCell>
                          <TableCell>
                            {moment(data.Delivery_Chellan_Date).format(
                              'DD-MM-YYYY',
                            )}
                          </TableCell>
                          ...
                          <TableCell>{data.ReceivedQty}</TableCell>
                        </TableRow>
                      ))
                    ) : (
