...
//   Getallpodetils(id)
  ...
  {/* <TableCell align="left">
      ...
      <TableCell align="left">
        ...
        <TableCell  align="left"><b>{(Total_discount_amt)}</b></TableCell>
        <TableCell  align="left" className='text-nowrap'><Badge style={{color:'white', fontSize:'14px',backgroundColor:"#58A7AA"}}>SGST</Badge> : <b>{((localStorage.getItem("IGSTApplicable")==='Y') && (localStorage.getItem("RegisterType")==="SEZ"))?0: localStorage.getItem("CStateId") === localStorage.getItem("COMPANY_STATECODE")?numeral(allpodetailscollections1.reduce((accumulator, currentValue) => accumulator + (((currentValue.Rate * currentValue.Order_Qty)-((currentValue.Rate * currentValue.Order_Qty)*(currentValue.Discount)/100))*(currentValue.GSTPer/2))/100, 0)).format('0,0.00'):0}</b></TableCell>
        <TableCell  align="left" className='text-nowrap'><Badge style={{color:'white', fontSize:'14px',backgroundColor:"#58A7AA"}}>CGST</Badge> : <b>{((localStorage.getItem("IGSTApplicable")==='Y') && (localStorage.getItem("RegisterType")==="SEZ"))?0:localStorage.getItem("CStateId") === localStorage.getItem("COMPANY_STATECODE")?numeral(allpodetailscollections1.reduce((accumulator, currentValue) => accumulator + (((currentValue.Rate * currentValue.Order_Qty)-((currentValue.Rate * currentValue.Order_Qty)*(currentValue.Discount)/100))*(currentValue.GSTPer/2))/100, 0)).format('0,0.00'):0}</b></TableCell>
        <TableCell className='text-nowrap'  align="left"><Badge style={{color:'white', fontSize:'14px',backgroundColor:"#58A7AA"}}>IGST</Badge> : <b>{((localStorage.getItem("IGSTApplicable")==='Y') && (localStorage.getItem("RegisterType")==="SEZ"))?numeral(allpodetailscollections1.reduce((accumulator, currentValue) => accumulator + (((currentValue.Rate * currentValue.Order_Qty)-(0))*(currentValue.IGSTPer))/100, 0)).format('0,0.00'):localStorage.getItem("CStateId") === localStorage.getItem("COMPANY_STATECODE")? 0: numeral(allpodetailscollections1.reduce((accumulator, currentValue) => accumulator + (((currentValue.Rate * currentValue.Order_Qty)-(0))*(currentValue.IGSTPer))/100, 0)).format('0,0.00')}</b></TableCell>
        {localStorage.getItem("CStateId") === localStorage.getItem("COMPANY_STATECODE")?
        <>
       
        <TableCell  align="left"><Badge style={{color:'white', fontSize:'14px',backgroundColor:"#58A7AA"}}>NET_AMT</Badge></TableCell>
        <TableCell  className='text-nowrap'  align="left"><b>{numeral((allpodetailscollections.reduce((accumulator, currentValue) => accumulator +(currentValue.Amount)+(((currentValue.Rate * currentValue.Order_Qty)-((currentValue.Rate * currentValue.Order_Qty)*(currentValue.Discount)/100))*(currentValue.GSTPer/2))/100 +(((currentValue.Rate * currentValue.Order_Qty)-((currentValue.Rate * currentValue.Order_Qty)*(currentValue.Discount)/100))*(currentValue.GSTPer/2))/100,0))-Total_discount_amt).format('0,0.00')}</b></TableCell>
        ...
        <TableCell  className='text-nowrap'   align="left"><b>{numeral((allpodetailscollections.reduce((accumulator, currentValue) => accumulator +(currentValue.Amount)+(((currentValue.Rate * currentValue.Order_Qty)-((currentValue.Rate * currentValue.Order_Qty)*(currentValue.Discount)/100))*(currentValue.IGSTPer))/100,0))-Total_discount_amt).format('0.0,00')}</b></TableCell>
